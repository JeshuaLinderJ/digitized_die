...
void d10(){
  if (button1Pressed) { // Button is pressed
    ...
    for(int i = 0 ; i < 14 ; i++){
      ...
      switch(i){
        case 1:
          drawD10Logic(80, 29, 50, TFT_RED, randomRoll(10));
          break;
        case 2:
          drawD10Logic(80, 29, 50, TFT_ORANGE, randomRoll(10));
          break;
        case 3:
          drawD10Logic(80, 29, 50, TFT_YELLOW, randomRoll(10));
          break;
        case 4:
          drawD10Logic(80, 29, 50, TFT_GREEN, randomRoll(10));
          break;
        case 5:
          drawD10Logic(80, 29, 50, TFT_BLUE, randomRoll(10));
          break;
        case 6:
          drawD10Logic(80, 29, 50, TFT_PURPLE, randomRoll(10));
          break;
        case 7:
          drawD10Logic(80, 29, 50, TFT_VIOLET, randomRoll(10));
          break;
        case 8:
          drawD10Logic(80, 29, 50, TFT_BLUE, randomRoll(10));
          break;
        ...
        case 13:
          ...
          drawD10Logic(80, 29, 50, TFT_WHITE, randomRoll(10));
          break;
      }
      delay(110);
    }
...
void drawD10Logic(int x, int y, int size, uint16_t color, int face) { // NOTE: Replace triangle logic with lines to avoid visual bugs
  int halfSize = size / 2;
  if(face == 1) {drawD10("1", color);
  } else if(face == 2){drawD10("2", color);
  } else if(face == 3){drawD10("3", color);
  } else if(face == 4){drawD10("4", color);
  } else if(face == 5){drawD10("5", color);
  } else if(face == 6){drawD10("6", color);
  } else if(face == 7){drawD10("7", color);
  } else if(face == 8){drawD10("8", color);
  } else if(face == 9){drawD10("9", color);
...
void d12(){
  if (button1Pressed) { // Button is pressed
    ...
    for(int i = 0 ; i < 14 ; i++){
      ...
      switch(i){
        case 1:
          drawD12Logic(80, 29, 50, TFT_RED, randomRoll(12));
          break;
        case 2:
          drawD12Logic(80, 29, 50, TFT_ORANGE, randomRoll(12));
          break;
        case 3:
          drawD12Logic(80, 29, 50, TFT_YELLOW, randomRoll(12));
          break;
        case 4:
          drawD12Logic(80, 29, 50, TFT_GREEN, randomRoll(12));
          break;
        case 5:
          drawD12Logic(80, 29, 50, TFT_BLUE, randomRoll(12));
          break;
        case 6:
          drawD12Logic(80, 29, 50, TFT_PURPLE, randomRoll(12));
          break;
        case 7:
          drawD12Logic(80, 29, 50, TFT_VIOLET, randomRoll(12));
          break;
        case 8:
          drawD12Logic(80, 29, 50, TFT_BLUE, randomRoll(12));
          break;
        ...
        case 13:
          delay(1000);
          drawD12Logic(80, 29, 50, TFT_WHITE, randomRoll(12));
          break;
      }
      delay(110);
    }
...
void drawD12Logic(int x, int y, int size, uint16_t color, int face) { // NOTE: Replace triangle logic with lines to avoid visual bugs
  int halfSize = size / 2;
  if(face == 1) {drawD12("1", color);
  } else if(face == 2){drawD12("2", color);
  } else if(face == 3){drawD12("3", color);
  } else if(face == 4){drawD12("4", color);
  } else if(face == 5){drawD12("5", color);
  } else if(face == 6){drawD12("6", color);
  } else if(face == 7){drawD12("7", color);
  } else if(face == 8){drawD12("8", color);
  } else if(face == 9){drawD12("9", color);
  } else if(face == 10){drawD12("10", color);
  } else if(face == 11){drawD12("11", color);
...
void d20(){
  if (button1Pressed) { // Button is pressed
    ...
    for(int i = 0 ; i < 14 ; i++){
      ...
      switch(i){
        case 1:
          drawD20Logic(80, 29, 50, TFT_RED, randomRoll(20));
          break;
        case 2:
          drawD20Logic(80, 29, 50, TFT_ORANGE, randomRoll(20));
          break;
        case 3:
          drawD20Logic(80, 29, 50, TFT_YELLOW, randomRoll(20));
          break;
        case 4:
          drawD20Logic(80, 29, 50, TFT_GREEN, randomRoll(20));
          break;
        case 5:
          drawD20Logic(80, 29, 50, TFT_BLUE, randomRoll(20));
          break;
        case 6:
          drawD20Logic(80, 29, 50, TFT_PURPLE, randomRoll(20));
          break;
        case 7:
          drawD20Logic(80, 29, 50, TFT_VIOLET, randomRoll(20));
          break;
        case 8:
          drawD20Logic(80, 29, 50, TFT_BLUE, randomRoll(20));
          break;
        ...
        case 13:
          delay(1000);
          drawD20Logic(80, 29, 50, TFT_WHITE, random(20));
          break;
      }
      delay(110);
    }
...
void drawD20Logic(int x, int y, int size, uint16_t color, int face) { // NOTE: Replace triangle logic with lines to avoid visual bugs
  int halfSize = size / 2;
  if(face == 1) {drawD20("1", color);
  } else if(face == 2){drawD20("2", color);
  } else if(face == 3){drawD20("3", color);
  } else if(face == 4){drawD20("4", color);
  } else if(face == 5){drawD20("5", color);
  } else if(face == 6){drawD20("6", color);
  } else if(face == 7){drawD20("7", color);
  } else if(face == 8){drawD20("8", color);
  } else if(face == 9){drawD20("9", color);
  } else if(face == 10){drawD20("10", color);
  } else if(face == 11){drawD20("11", color);
  } else if(face == 12){drawD20("12", color);
  } else if(face == 13){drawD20("13", color);
  } else if(face == 14){drawD20("14", color);
  } else if(face == 15){drawD20("15", color);
  } else if(face == 16){drawD20("16", color);
  } else if(face == 17){drawD20("17", color);
  } else if(face == 18){drawD20("18", color);
  } else if(face == 19){drawD20("19", color);
  } else if(face == 20){drawD20("20", color);}
}

void drawD20(String face, uint16_t color){
  ...
  tft.setTextColor(TFT_WHITE, TFT_BLACK);
  tft.setTextSize(2);
  tft.drawCentreString(face, 80, 32, 1);
}
// ================================================
// Random roll logic
